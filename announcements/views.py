...
def add_announcement(request):
    ...
    return render(
        request,
        "announcement/add_announcement.html",
        {"page_title": page_title, "form": form, "submitted": submitted},
    )
...
def edit_announcement(request, announcement_id):
    ...
    return render(
        request,
        "announcement/edit_announcement.html",
        {"page_title": page_title, "announcement": announcement, "form": form},
    )
...
def discord_announcement(request):
    ...
    r = requests.post(
        "https://discord.com/api/v9/channels/1051992533842010132/messages",
        data=payload,
        headers=header,
    )
